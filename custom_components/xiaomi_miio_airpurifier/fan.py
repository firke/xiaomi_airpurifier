...
MODEL_AIRPURIFIER_4 = "zhimi.airp.mb5a"
...
PURIFIER_MIOT = [MODEL_AIRPURIFIER_3, MODEL_AIRPURIFIER_3H, MODEL_AIRPURIFIER_4, MODEL_AIRPURIFIER_ZA1]
...
AVAILABLE_ATTRIBUTES_AIRPURIFIER_4 = {
    ATTR_POWER: "power",
    ATTR_MODE: "mode",
    ATTR_FAN_LEVEL: "fan_level",
    ATTR_ANION: "anion",
...
OPERATION_MODES_AIRPURIFIER_4 = ["Auto", "Sleep", "Manual"]
...
async def async_setup_platform(hass, config, async_add_entities, discovery_info=None):
    ...
    elif model.startswith("zhimi.airpurifier.") or model.startswith("zhimi.airp."):
...
class XiaomiAirPurifier(XiaomiGenericDevice):
    ...
    def __init__(self, name, device, model, unique_id, retries=0):
        ...
        elif self._model == MODEL_AIRPURIFIER_4:
            self._device_features = FEATURE_FLAGS_AIRPURIFIER_4
            self._available_attributes = AVAILABLE_ATTRIBUTES_AIRPURIFIER_4
            self._preset_modes = OPERATION_MODES_AIRPURIFIER_4
        else:
